...
@Messages({
    "LBL_AppProps_LOADER=Files of AppProps"
})
...
public class AppPropsDataObject extends MultiDataObject {

    public AppPropsDataObject(FileObject pf, MultiFileLoader loader) throws DataObjectExistsException, IOException {
        super(pf, loader);
